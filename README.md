...
<ins>Note</ins> : The XIAOs internal RTC is garbage. An external RTC should be used for reliable time keeping. See upgraded versions log<sup>2</sup> and log<sup>3</sup>.
